...
|---|---|---|
| `/workspaces/:wid?tab=overview` | Overview | Queue status, recent sessions |
| `/workspaces/:wid?tab=peers` | PeerList | `POST /peers/list` |
| `/workspaces/:wid/peers/:pid/representation` | PeerRepr | `POST /representation` |
| `/workspaces/:wid/peers/:pid/card` | PeerCard | `GET /card` |
| `/workspaces/:wid/peers/:pid/chat` | PeerChat | `POST /chat` |
| `/workspaces/:wid?tab=sessions` | SessionList | `POST /sessions/list` |
| `/workspaces/:wid/sessions/:sid` | SessionView | `GET /context`, `POST /messages/list` |
| `/workspaces/:wid?tab=conclusions` | ConclusionList | `POST /conclusions/list`, `POST /conclusions/query` |
